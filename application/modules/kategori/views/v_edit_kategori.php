            ...
            <div class="col-md-12" id="form_panel">
                <form class="form-horizontal" role="form">
                    <div class="input-group">
                        <span class="input-group-addon">Id kategori</span>
                        <input type="text" class="form-control" placeholder="" name="id_kategori" id="id_kategori" value="<?php echo $table_content[0]["id_kategori"]; ?> ">
                    </div>
                    <div class="input-group">
